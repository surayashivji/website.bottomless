...
sf.onLoadClick = (e) => {
    ...
    var formLength = "85vw";
    if(mobileCheck()) {
        document.getElementById("img-type").src="assets/mobiletype.png";
    } else {
        document.getElementById("img-type").src="assets/desktoptype.png";
        formLength = "40rem";
    }

    sf.container.style.width = formLength;
...
sf.submitForm = () => {
    ...
    var phoneNumberText = document.getElementById('phone-input').value;
